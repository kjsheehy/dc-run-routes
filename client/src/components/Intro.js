  ...
  return (
    <Modal close={props.close} className="page-intro">
      <p className="page-description">
        ...
        routes in and around DC.{' '}
        {/*There's some info about each route, including
      ...
      <p></p>
      <p className="page-description">
        Note that most of the info, images, and links on the route detail page
        are currently just placeholders for development and demo purposes. More
        to come!
      </p>
